...
export const BIRD_SPECIES: Record<BirdKind, BirdSpecies> = {
  parrot: {
    ...
    label: "parrot",
    size: 1.2,
    // amazon green with a warm cheek
    body: [0.18, 0.62, 0.28],
  ...
  duck: {
    ...
    label: "duck",
    size: 1.25,
    // mallard green-head / chestnut breast read as teal
    body: [0.14, 0.42, 0.34],
  ...
  "bird-of-paradise": {
    ...
    size: 1.3,
    // velvet-black body; gold cape is painted in the SDF accent pass
    body: [0.08, 0.07, 0.09],
    places: ["tree", "fruit", "grass"],
