...
export const GUIDE_ROOMS: GuideRoom[] = [
  ...
  },
  {
    ...
    href: "/birds",
    essence:
      "several thousand birds over an evening field, where the order of the flock is the shape of the sound: a scattered sky chatters across a stretched stack of partials, and a murmuration collapses onto one ringing note.",
    moves: [
      "tilt the device → the wind; the whole flock banks into it, and the horizon leans with you",
      "shake → the sky bursts and gathers itself again, the sound falling to chatter and climbing back",
      "tap → the birds nearest your finger break away, and the flock calls",
      "hold one finger → the flock gathers to it, harder the longer you wait; past the ceremony it settles onto your hand as one animal",
      ...
      "flick → a gust; knock → one wave of wingbeats crosses the sky; lay it face-down → night, and the flock goes slow",
