...
const CORE_GUIDE_ROOMS: GuideRoom[] = [
  // --- threshold ---
  {
    ...
    title: "home",
    href: "/",
    essence: "the door opens onto the manifold itself — every scale kept in one fold, the whole album standing behind one address.",
    moves: [
      "arrive → the fold receives you; the axis is already under your hand",
      "\"view all\" → the constellation panel lists every room in scale order",
      "the header's sigil → returns you to the fold from any room",
    ],
    finds: [
  ...
  },
  {
    ...
    essence: "one continuous generative world-plane you roam by camera — drag to travel, pinch to fall through layer after layer of freshly drawn ground, tap a landmark to open a whole map of that thing.",
    moves: [
      ...
      "pinch in → keep pressing and the ground opens: each layer is a new sheet drawn at half the ground and its own full resolution, dissolving over the one above it. two dozen layers deep is reachable, and nothing is ever a stretched copy of the layer before",
      "pinch out at the floor → climbs back out one layer, landing exactly where the descent left; at the outermost chart it asks for a wider territory instead",
    ...
    finds: [
      ...
      "descending changes what kind of map it is, not only how sharp: continents give way to districts, then streets, then a worked surface, then the grain under it",
      "place names quiet themselves each time a deeper sheet lands, and rise again as you outrun it",
  ...
  },
  {
    ...
    moves: [
      ...
      "two still fingers (a span) → the interval held open: the nearest chain's two voices stay audible and its strain may not settle while you listen",
      "a steady tap tempo → the chains take up your pulse and re-beat on it after the taps have stopped",
      "three fingers drag → warmth, which holds every chain off its floor",
      "three fingers hold → time dilates, deeper the longer the fingers stay",
  ...
  },
  {
    ...
    moves: [
      "tap → excites an electron, ring flashing outward, sized like the touch",
      "triple-tap → ionizes: the outermost electron streaks off and falls home a beat later; on open vacuum the taps condense an atom",
      "five-tap → photolysis: every bond on the struck atom lets go at once, the partners thrown back with the recoil",
      "rapid train past seven → a spectral cascade — every cloud in reach jumps in sequence",
      "a steady tap tempo → electrons jump on your beat for as long as the tempo would carry",
      ...
      "three-finger hold → slows time, deeper the longer it is held — the deliberate way to line up a fusion",
  ...
  },
  {
    ...
    moves: [
      ...
      "triple-tap → the photoneutron: a neutron is knocked out of any drop; on open field one is shaken from the vacuum itself",
      "five-tap a drop → it does what it already wanted, now — beta, alpha, or fission; a stable drop sings its stillness",
      "rapid train past seven → the drumroll summons the rain: the neutron flux itself rises and every drop rings under it",
      "drum two spots alternately → neutrons volley across the space between the hands, captured by the drops in the crossfire",
      "a steady tap tempo → the decay clocks hurry to your pulse, steadier taps pulling harder",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a spray of pairs → the hadron under the hand speaks its chord and spins up → it radiates a photon from every quark → the whole vacuum boils over",
      "two still fingers held apart → the vacuum strings a flux tube between them; held to the dwell it condenses into a real pair where the fingers stood",
      "a steady tapped pulse → the seethe boils on your beat for a while",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → energy hammered straight in: three taps afford an electron pair, five the muons, seven the taus — and the whole field answers",
      "two still fingers → a standing wave held open between them, the interval its wavelength; release lets it go as light of exactly that pitch",
      "a steady tapped pulse → the vacuum's flicker falls in with your tempo",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → ember → spark fountain → the draft opens → the whole bed roars",
      "two still fingers held apart → the bellows: sparks stream up the held interval, deeper the longer it is sustained",
      ...
      "three-finger hold → time thickens for as long as the hand stays, down to a tenth speed",
  ...
  },
  {
    ...
    moves: [
      ...
      "circle a finger → the auger: it bites deeper the further it winds, and a full second turn brings up cuttings from the layers below",
      "two still fingers held apart → a standing load: each fingertip sounds its stratum, the pair an interval closing toward unison as the rock between them creeps",
  ...
  },
  {
    ...
    moves: [
      ...
      "three fingers held → time thickens: the sky's clock stretches deeper the longer they stay",
      "drum two spots → each hit rings at its own height, and a steady patter sends a comet from one hand to the other",
      "two still fingers held apart → a span: the sky sustains the dyad, a ring pulsing under the held interval",
      "tap a steady beat → the whole sky answers on your tempo",
  ...
  },
  {
    ...
    moves: [
      ...
      "two still fingers held apart → a span: the wells under each fingertip sound their interval together, and the filament between them wakes the longer it is held",
      "patter two hands → the galaxy nearest each hand answers in alternation, and the web between them stirs",
      "tap a steady beat → the web's minute-long clock entrains to the hand's tempo, then settles home",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a note → its instrument strums a triad → the pitch walks all eight instruments → the whole orchestra sounds it at once",
      ...
      "a steady tapped pulse → the kept chords replay in your own tempo",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a voice → its own triad → a glissando strummed across the open pitch window → the whole chain sounds the pitch at once",
      "a steady tapped pulse → the last note echoes on each beat, the readout flashing in time",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a spark → a threefold fork → the banked charge discharges at once → the globe overloads in a ring of flares",
      "two still fingers on the glass → an arc bridges them, glass to glass, humming higher the longer the interval holds",
      "drum two spots alternately → the lightning leaps between your hands",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a bloom → an ectopic triplet of beats → an adrenaline surge → the paddles: a full shock by hand",
      "two still fingers held apart → the breath is held: the trace flattens, and past a few seconds the heart starts to climb; release is the exhale",
      "drum with two hands, alternating → becomes the heart's own pacemaker, overriding its autonomous beat",
      "a steady tapped pulse → the heart falls in with your tempo for a while",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a point speaks → the field reseeds → the last candles ring their closes in order → volatility crescendos toward storm",
      "scrub (circle a finger) → winds volatility, with the turn stormier and against it calm",
      "a steady tapped pulse → the scan line locks to your tempo for a while",
    ...
    finds: [
      ...
      "a long hold does two things in sequence: the candle grows past 900ms — faster the longer you stay — and past 2500ms the reading is pinned",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → the month holds → the surface re-inks itself in the next pattern → the ink changes color → density floods and the signal replays",
      "flick → strums all eight months in order",
      "scrub (circle a finger) → stirs the ink: density gathers with the turn and thins against it",
      "a steady tapped pulse → the signal breathes on your beat for a while",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a touch → the twin returns, two notes opening apart by γ → the well sheds mass in a gravitational ring → the clocks race, proper time falling behind a second per tap",
      ...
      "three-finger drag → drifts the flow of the clock; three-finger hold → both clocks slow, and keep slowing the longer you stay",
      "a steady tapped pulse → the clocks fall in with your tempo for a while",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a part speaks → the quarter repeater strikes → the gong counts the hour the hands are telling → grande sonnerie, every gear ringing",
      "scrub (circle a finger) → turns the crown, ratcheting the mainspring — a faster wrist pours more wind in",
      "two still fingers on the case → hacking seconds: the train stills the longer they rest, and springs back to beat on release",
      "a steady tapped pulse → the escapement beats audibly with you for a while",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a ring → a prismatic triad flares → every planted facet catches the light in turn → the stone blazes",
      "drum two spots alternately → the lamp leaps between your hands, two pitches trading",
      "flick → throws it into a fast spin",
      "twist → turns the stone over to its mirror face",
      "three fingers twisted → the light's season turns, a detent at each solstice; held still, the stone's time keeps slowing",
      "hold on open gold → gathers a facet; held on a facet to the ceremony tier → annihilates it",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a poke → the kernel knocks inside its husk → the husk nicks visibly → the seed rattles itself awake",
      "hold → grows the radicle; ceremony splits the husk, wider the longer it is carried past the tier",
      "two still fingers held apart → a cradle: held warmth, and the embryo grows gently for as long as the interval is sustained",
      "a steady tap tempo → the seed's breath falls in with your pulse",
      "drag → nudges its lean",
      "scrub → stirs the soil; the seed leans with the swirl, further the faster you circle",
      "three-finger tap → a soft pulse through the field, as hard as the chord landed",
    ...
    finds: [
      ...
      "the cradle and the press are different warmths: two still fingers grow the embryo without ever splitting the husk",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps (1 / 3 / 5 / n) → a flip → the region rings its triad → a grand toss with the octave running beneath → the peal, the night pulsing wave on wave",
      "drum two spots alternately → the medal teeters between your hands, root under one and fifth under the other",
      "drag → resizes or tilts it; a fast drag rubs it to a shine",
      "scrub (circle a finger) → turns it in-plane, the octave sweeping faster with the wrist",
      "a steady tapped pulse → the aventurine night twinkles in your tempo",
      "twist → rotates it in the hand; a full turn flips it to its other face",
      "three fingers held → its time keeps slowing for as long as the chord stays",
  ...
  },
  {
    ...
    moves: [
      ...
      "rapid taps on the flame (1 / 3 / 5 / n) → a spark → the flame leaps and throws a ring → the whole room catches the light, instrument by instrument → the wick roars",
      ...
      "scrub (circle a finger) → turns the crown of the room's day: sun, clock and pendulum obey",
      "a steady tapped pulse → the pendulum falls in with your hand for a while",
