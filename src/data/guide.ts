...
const CORE_GUIDE_ROOMS: GuideRoom[] = [
  ...
  },
  {
    ...
    moves: [
      ...
      "double-tap → creates a new bird near the hand with a chirp and haptic bloom",
      "triple-tap → culls the touched bird, or clears the aviary down to a few witnesses",
  ...
  },
  {
    ...
    moves: [
      ...
      "hold a star → you ride its orbit; every arm it crosses lands as one felt tick, faster near the centre, silent at corotation, and the longer you hold the closer the eye leans in",
      ...
      "arrows → left and right lean the eye, up and down walk a ring along the rotation curve, each step heard; enter → follows the nearest star on the ring; held enter → rides it deeper; v → the veil, held long it grows the bar; esc → lowers everything",
    ],
    finds: [
    ...
    keeps: "the stars you have ridden through an arm",
  },
  {
    key: "space",
