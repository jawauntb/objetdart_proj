...
export const GUIDE_ROOMS: GuideRoom[] = [
  ...
  },
  {
    ...
    moves: [
      ...
      "three-finger hold → both clocks slow to a quarter speed",
    ],
    finds: ["on a phone, a single tap starts and stops the clocks; on a desktop the same tap sets velocity and mass at once"],
  },
  {
    key: "movement",
