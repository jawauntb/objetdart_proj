...
export const GUIDE_ROOMS: GuideRoom[] = [
  ...
  },
  {
    ...
    essence:
      "a peak above the sea of fog — matterhorn horns, lee cornices, glacier ice, scree, and cairns kept by hand.",
    moves: [
    ...
    finds: [
      ...
      "glacier tongues gather in the bowls below the snowline, blue-grey where the valley holds them",
  ...
  {
    key: "birds",
    title: "the flock as one animal",
    scale: "the birds band — between the flowers below and the shore above",
    href: "/birds",
    essence:
      "several thousand birds over an evening meadow — thirteen kinds from parrot to bird of paradise, some murmuring in the air, some perched, drinking, swimming, hopping or strutting — where the order of the flock is the shape of the sound.",
    moves: [
      "tilt the device → the wind; the whole flock banks into it, and the horizon leans with you",
      "shake → the sky bursts and gathers itself again; residents leave tree and pond for the air",
      "tap → flushes nearby birds into flight and startles the murmuration; the flock calls",
      "hold one finger → roosts the nearest bird onto perch or grass; held longer, the flock gathers to the hand, and past the ceremony settles as one animal",
      "drag one finger → a hand drawn through the flock pushes it aside",
      ...
      "knock → one wave of wingbeats crosses the sky; lay it face-down → night, and the flock goes slow",
    ...
    finds: [
      "ducks keep the pond, hummingbirds the fruiting canopy, raptors the upper air, peacocks and paradise the grass — each kind tinted on the GPU point sprites",
      "the meadow under the horizon is one sky shader (tree, fruit, pond, hay, grass, clouds); the murmuration is one POINTS draw over typed arrays",
