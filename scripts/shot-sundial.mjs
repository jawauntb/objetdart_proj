...
await p.goto("http://localhost:3200/tourbillon?spin=0&view=top", { waitUntil:"load" });
await p.waitForFunction(()=>window.__tourbillon&&window.__tourbillon.ready===true,{timeout:60000}).catch(()=>errs.push("no ready"));
await p.waitForTimeout(2500);
// full page
await p.screenshot({ path: "iterations/iter-12/tourbillon-full.png" });
