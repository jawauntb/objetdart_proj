...
const outDir = "iterations/reference-smoke";
...
const routes = [
  { name: "archive", url: "/archive", headerHidden: false },
  { name: "kept", url: "/kept", headerHidden: false },
  { name: "colophon", url: "/colophon", headerHidden: false },
