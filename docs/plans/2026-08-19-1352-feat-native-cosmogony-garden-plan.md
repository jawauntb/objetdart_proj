---
title: "feat: Rebirth objet d'art as a native cosmogony garden"
date: 2026-08-19
...
```mermaid
flowchart TB
  subgraph JS["Expo application layer"]
    Router["Expo Router"]
    UI["fold, trail, guide, settings"]
    A11y["accessibility action surfaces"]
  end

  subgraph Native["Swift native layer"]
    Host["NativeUniverseHost"]
    Clock["monotonic universe clock"]
    Grammar["semantic gesture and vessel router"]
    Sensory["audio and Core Haptics buses"]
    DB["write-ahead universe store"]
    Sync["CloudKit sync and branch reconciliation"]
  end

  subgraph Science["ObjetUniverseKit"]
    Contract["simulation contract"]
    Wave["wave and spectral kernel"]
    Cell["cell and reaction-diffusion kernel"]
    Solar["solar gravity and accretion kernel"]
    History["domain and natural-history events"]
  end

  subgraph Render["material renderers"]
    Skia["Skia coarse overlays"]
    Reality["RealityKit entity scenes"]
    Metal["Metal fields, compute, and populations"]
  end
...
stateDiagram-v2
  [*] --> Loading
  Loading --> Inhabiting: checkpoint validated
  Loading --> Recovery: corrupt or incompatible checkpoint
  Recovery --> Inhabiting: last valid checkpoint or new branch
  Inhabiting --> Traveling: scale or lens commitment
  Traveling --> Inhabiting: handoff committed
  Traveling --> Inhabiting: interrupted and reversed
  Inhabiting --> Suspended: app inactive or hidden
  Suspended --> Advancing: elapsed time classified
  Advancing --> Inhabiting: bounded domain advance committed
  Inhabiting --> Branching: sync divergence or explicit rewind
  Branching --> Inhabiting: current branch selected
  Inhabiting --> Retired: reversible retirement ceremony
  Retired --> Inhabiting: restore
  Retired --> Purging: separate purge confirmation
  Purging --> [*]: local deletion and cloud tombstone committed
```
...
```mermaid
flowchart LR
  U1["U1 workspace"] --> U2["U2 contracts"]
  U1 --> U3["U3 native host"]
  U2 --> U3
  U2 --> U4["U4 persistence"]
  U3 --> U4
  U2 --> U5["U5 gestures"]
  U3 --> U5
  U3 --> U6["U6 sensory"]
  U2 --> U7["U7 design and pedagogy"]
  U3 --> U8["U8 evidence foundation"]
  U6 --> U8
  U3 --> U9["U9 wave vertical slice"]
  U4 --> U9
  U5 --> U9
  U6 --> U9
  U7 --> U9
  U8 --> U9
  U9 --> G1["gate: wave proves the shared stack"]
  G1 --> U10["U10 cell"]
  G1 --> U11["U11 solar"]
  U9 --> U12["U12 fold and travel"]
  U10 --> U12
  U11 --> U12
  U4 --> U13["U13 trail"]
  U7 --> U13
  ...
  U10 --> U13
  U11 --> U13
  U12 --> G2["gate: local-first TestFlight validation"]
  U13 --> G2
  G2 --> U14["U14 sync"]
  U4 --> U14
  U5 --> U15["U15 adaptive and accessible UX"]
  U7 --> U15
  U12 --> U15
  U13 --> U15
  U14 --> U15
  U4 --> U16["U16 integrated evidence"]
  U8 --> U16
  U9 --> U16
  U10 --> U16
  U11 --> U16
  ...
  U14 --> U16
  U15 --> U16
  U12 --> U17["U17 release validation"]
  U13 --> U17
  U14 --> U17
  U15 --> U17
  U16 --> U17
